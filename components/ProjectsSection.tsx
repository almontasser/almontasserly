  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative mt-10 flex items-center justify-center">
        <button
          type="button"
          className="swiper-custom-button-prev group mr-4 flex h-full cursor-pointer items-center justify-center focus:outline-none"
          data-carousel-prev
        >
        ...
        <button
          type="button"
          className="swiper-custom-button-next group flex h-full cursor-pointer items-center justify-center focus:outline-none"
          data-carousel-next
        >
          <span className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">
            <svg
